...
class FacePhotoSubmissionModel(Base):
    ...
    max_user_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
...
class MaxGuestBindingModel(Base):
    __tablename__ = "max_guest_bindings"
    __table_args__ = (
        UniqueConstraint("max_user_id", "reservation_external_id", name="uq_max_user_reservation"),
    )
