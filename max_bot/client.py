...
class SmartLockerMaxApiClient:
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=20, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/bookings",
    ...
    async def get_bound_bookings(
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=20, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/bindings",
                headers=self._headers,
                data={"max_user_id": max_user_id},
            )
        self._raise_for_status(response)
        return response.json()
    ...
    async def bind_booking(
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=20, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/bind",
                headers=self._headers,
                data={
    ...
    async def unbind_booking(
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=20, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/unbind",
                headers=self._headers,
                data={
                    "reservation_code": reservation_code,
                    "max_user_id": max_user_id,
    ...
    async def lookup_guest_access(
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=20, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/access",
                headers=self._headers,
    ...
    async def upload_face_photo(
        ...
        *,
        ...
        async with httpx.AsyncClient(timeout=60, trust_env=False) as client:
            response = await client.post(
                f"{self._api_base_url}/api/v1/max/guest/face-photo",
                headers=self._headers,
                data={
                    "reservation_code": reservation_code,
