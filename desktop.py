...
class MainWidget(QWidget):
    ...
    def _start_worker(self, worker: WorkerThread, *, busy_message: str, on_result, on_error=None) -> None:
    ...
    def _activate_lock_job(self) -> dict[str, object]:
    ...
    def activate_lock_async(self) -> None:
        ...
        self._start_worker(
            ...
            on_result=on_result,
            on_error=lambda message: QMessageBox.critical(self, "Активация", message),
        )
